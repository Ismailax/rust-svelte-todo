...
pub fn load_env() -> AppConfig {
    ...
    AppConfig {
        ...
        jwt_private_key_pem: env::var("JWT_PRIVATE_KEY_PEM").expect("Missing JWT_PRIVATE_KEY_PEM"),
        jwt_public_key_pem: env::var("JWT_PUBLIC_KEY_PEM").expect("Missing JWT_PUBLIC_KEY_PEM"),
